...
{
    public class ManageRaceController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var raceList = db.Events.ToList();
            ViewBag.distances = buildSelectList(raceList,distances);
        ...
        private List<SelectListItem> buildSelectList(IEnumerable<Event> inList,IEnumerable<distance> dlist)
        {
            ...
            foreach (var item in inList)
            {
                ...
                {
                    Text = item.Title,
                    Value = dlist.FirstOrDefault(d =>  d.Code == item.DistanceCode).Value.ToString(),
                };
                slist.Add(option);
            }
            return slist;
